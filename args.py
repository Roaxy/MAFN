...
def get_parser():
    ...
    parser.add_argument('--ck_bert', default='/home/sld/lqx/RMSIN/bert-base-uncased', help='pre-trained BERT weights')
    parser.add_argument('--clip_pretrain', default='/home/sld/lqx/RMSIN/ViT-B-16.pt', help='pre-trained CLIP weights')
    parser.add_argument('--word_len', default=20,type=int, help='pre-trained CLIP weights')
    ...
    parser.add_argument('--pretrained_swin_weights', default='/home/sld/lqx/RMSIN/swin_base_patch4_window12_384_22k.pth',
                        help='path to pre-trained Swin backbone weights')
    ##/home/sld/lqx/RMSIN/swin_base_patch4_window12_384_22k.pth
    parser.add_argument('--print-freq', default=10, type=int, help='print frequency')
    parser.add_argument('--refer_data_root', default='/home/sld/lqx/RMSIN/refer/data/', help='REFER dataset root directory')
    ...
    parser.add_argument('--kernels', type=int, nargs='+', default=[1,3,5], 
                        help='Different kernels in multi-scale rotated convolutions')
