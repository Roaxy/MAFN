...
class CrossScaleAttention(nn.Module):
    def __init__(self, dim, img_shape=900, att_shape=1225):
        super().__init__()
    ...
    def forward(self, x):
        ...
        attn = attn.permute(0, 2, 1).contiguous().view(x0.shape[0], x0.shape[1], 30, 30)
...
if __name__ == '__main__':
    model = CIM(1920)
    x1 = torch.randn(2, 128, 240, 240)
    x2 = torch.randn(2, 256, 120, 120)
    x3 = torch.randn(2, 512, 60, 60)
    x4 = torch.randn(2, 1024, 30, 30)
